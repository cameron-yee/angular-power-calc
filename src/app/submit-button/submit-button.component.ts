  ...
  ngAfterViewInit() {
    ...
    let messages = () => {
      ...
      try {
        ...
        let r2_domain: string = values['r2-domain'].toLowerCase();
        ...
        if(r2_covariate === 'Demo Only') {
          ...
          if(r2_impact === '2-level') {
            r2_messages_values = [`table7.twolevelhlm.${r2_state.toLowerCase()}.${r2_domain}.grade${r2_grades}r2l2`];
          } else {
            r2_messages_values = [`table7.threelevelhlm.${r2_state.toLowerCase()}.${r2_domain}.grade${r2_grades}r2l2`,`table7.threelevelhlm.${r2_state.toLowerCase()}.${r2_domain}.grade${r2_grades}r2l3`];
          }
        } else if(r2_covariate === 'Individual Level Pretest') {
          if(r2_impact === '2-level') {
            r2_messages_values = [`table8.twolevelhlm.${r2_state.toLowerCase()}.${r2_domain}.grade${r2_grades}r2l1`,`table8.twolevelhlm.${r2_state.toLowerCase()}.${r2_domain}.grade${r2_grades}r2l2`];
          } else {
            r2_messages_values = [`table8.threelevelhlm.${r2_state.toLowerCase()}.${r2_domain}.grade${r2_grades}r2l1`,`table8.threelevelhlm.${r2_state.toLowerCase()}.${r2_domain}.grade${r2_grades}r2l2`,`table8.threelevelhlm.${r2_state.toLowerCase()}.${r2_domain}.grade${r2_grades}r2l3`];
          }
        }
